...
- A separate methodology PDF for submission.
...
├── docs/
│   └── rag_methodology.pdf        Separate submission explanation
├── scripts/
│   ├── ingest.py                  Rebuild the document index
│   └── build_submission_pdf.py    Generate the methodology PDF
├── src/
│   ├── __init__.py
...
## 13. Submission methodology PDF

The separate submission explanation is generated by:
